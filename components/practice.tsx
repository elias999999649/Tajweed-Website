...
function ruleLink(question: PracticeQuestion): string {
  ...
  return `/tajweed/${rule?.slug ?? question.relatedRule}`;
}
...
export function Quiz({ questions }: { questions: PracticeQuestion[] }) {
  ...
  if (!question) return <div className="practice-empty"><h3>No questions match these filters.</h3><p>Try choosing “All levels” or a different category to continue practising.</p></div>;
