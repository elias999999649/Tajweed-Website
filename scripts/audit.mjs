...
if (stats.totalLessons === tajweedRules.length) ok("every lesson has a quiz");
else fail("some lessons are missing a quiz");
...
console.log(`  Review-stage lessons: ${stats.totalLessons - approvedRuleCount}`);
